...
__FLAME_GPU_FUNC__ int ProcessSpaceOperatorMessage(xmachine_memory_FloodCell* agent, xmachine_message_SpaceOperatorMessage_list* SpaceOperatorMessage_messages)
{
...

	{
		if (msg->inDomain == 1)
		{
				...
				&& agent->y == msg->y)
			{
				...
				//else
				//{
					double& h_R_E  = msg->hFace_W;
					double& et_R_E = msg->etFace_W;
			...
			/*	double h_R_W,  h_L_W,  et_R_W, et_L_W;
				...
				{*/
				double& h_L_W = msg->hFace_E;
				double& et_L_W = msg->etFace_E;
			...
			/*	double h_R_N, h_L_N, et_R_N, et_L_N;
				...
				{*/
				double& h_R_N = msg->hFace_S;
				double& et_R_N = msg->etFace_S;
	...
	/*			double h_R_S, h_L_S, et_R_S, et_L_S;
				...
				{*/
				double& h_L_S = msg->hFace_N;
				double& et_L_S = msg->etFace_N;
