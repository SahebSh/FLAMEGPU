...
int main()
{
	...
	int BOUNDARY_EAST_STATUS  = 1;
	int BOUNDARY_WEST_STATUS  = 2;
	int BOUNDARY_NORTH_STATUS = 2;
	int BOUNDARY_SOUTH_STATUS = 2;


	// INFLOW DATA
	//Time
	double FLOOD_START_TIME		= 0.0;	// (unit: seconds)
	double DISCHARGE_PEAK_TIME	= 2.0;	
	double FLOOD_END_TIME		= 3.0;		

	//Discharge info
	double DISCHARGE_INITIAL	=0.0;	// (unit: m2/s)
	double DISCHARGE_PEAK		=0.5;
	double DISCHARGE_END		=0.0;

	// the location of inflow boundary:
	double x1_boundary = 40;
	double x2_boundary = 60;
	double y1_boundary = 20;
	double y2_boundary = 30;
